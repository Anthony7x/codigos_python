'''Escreva um programa que pergunte ao usuário o valor de uma conta em um restaurante e o percentual de gorjeta que ele deseja dar (por exemplo, 10%, 15% ou 20%). 
O programa deve calcular e exibir o valor da gorjeta e o valor total da conta com a gorjeta incluída.
'''
